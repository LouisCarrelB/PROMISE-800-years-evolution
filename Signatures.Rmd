...
file_path <- paste0("/Users/louiscarrel/Documents/Alignement_Project/",GENE,"/New_alignement_biga3m/")
file_list <- list.files(path = file_path, pattern = "\\.fasta$", full.names = TRUE)

# Lecture des fichiers d'alignement
ali_can<- readAli(paste0(file_path, "msa_s_exon_17_0.fasta"))

ali_alt1 <- readAli(paste0(file_path, "msa_s_exon_17_1.fasta"))
ali_alt2 <- readAli(paste0(file_path, "msa_s_exon_17_2.fasta"))

ali_alt <- cbind(ali_alt1,ali_alt2)
...
write.csv(scores_ali_alt, file = paste0(GENE ,"/inter/scores_ali_alt.csv"), row.names = FALSE)
write.csv(scores_ali_can, file = paste0(GENE ,"/inter/scores_ali_can.csv"), row.names = FALSE)
