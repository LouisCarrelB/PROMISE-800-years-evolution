...
# base_path = "ENSG00000107643/thoraxe_2/msa/"
# file_names = [os.path.join(base_path, f"msa_s_exon_22_{i}.fasta") for i in (13,14, 15)]
...
# AlignIO.write(concatenated_alignment, os.path.join("ENSG00000107643/thoraxe_2/", "combined_filtered_alt.fasta"), "fasta")
